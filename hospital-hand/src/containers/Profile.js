            ...
            <div className="profile-bg" >
                ...
                <div className="container main-content-wrap" >
                    <div className="row" >
                        ...
                        </div> <div className="col-md-9 work-display" >
                            <ProfileButtons getUpdateStatus={this.updatedStatus} />
                            {(!this.state.isUpdate) ? < ProfileHomeContent /> : < UpdateProfile sendUserData={this.state}
                                getUpdatedUser={this.updatedUserProfile} />} </div >
                    </div>
                </div >
            </div>
        </>
